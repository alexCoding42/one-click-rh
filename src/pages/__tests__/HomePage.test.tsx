...
describe('<HomePage />', () => {
  it('display a title', () => {
    ...
    expect(title).toHaveTextContent('Prenez un rendez-vous téléphonique au Click et Kiosque RH');
  });
  ...
  it('display a subtitle', () => {
    ...
    expect(subtitle).toHaveTextContent("Les experts de l'administration et de la paie vous répondent");
  });
